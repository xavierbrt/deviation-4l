...
})(window,document,'script','dataLayer','GTM-M8BVP7L');</script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-125854934-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-125854934-1');
</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M8BVP7L"
